...
SECRET_KEY = 'django-insecure--zvw&71)0#=zx0@ohc$iw3bq+n2@4zcx=h*+pyf3(c6bnv-t(s'
...
#Djoser section for authentication
DJOSER= {
...
#added a staticfiles dir so they are not tied to a given app
STATICFILES_DIRS =[
    BASE_DIR / "static",
]
